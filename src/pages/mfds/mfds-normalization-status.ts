...
export const MFDS_NORMALIZATION_STATUS_MAP = {
  PENDING: {
    ...
    panelClassName: 'border-slate-200 bg-slate-50/70 dark:border-slate-800 dark:bg-slate-950/20',
  },
  STALE: {
    value: 'STALE',
    label: '재정규화 필요',
    ...
    panelClassName: 'border-blue-200 bg-blue-50/70 dark:border-blue-800 dark:bg-blue-950/20',
  },
  NORMALIZED: {
    value: 'NORMALIZED',
    label: '정규화 완료',
  ...
  PARTIAL: {
    ...
    panelClassName: 'border-amber-200 bg-amber-50/70 dark:border-amber-800 dark:bg-amber-950/20',
  },
  REVIEW_REQUIRED: {
  ...
  UNPARSED: {
    ...
    panelClassName: 'border-red-200 bg-red-50/70 dark:border-red-800 dark:bg-red-950/20',
  },
