...
interface CurationExposurePeriodTooltipProps {
  ariaLabel?: string;
  content?: string;
}

export function CurationExposurePeriodTooltip({
  ariaLabel = '모집기간 안내',
  content = '모집 기간동안 보틀노트 앱에서 노출됩니다.',
}: CurationExposurePeriodTooltipProps) {
  return (
